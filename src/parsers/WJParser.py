...
（也即对于选股而言，未来10天的走势最为重要，这样的持股时间也比较符合心理预期），
不必考虑过去太长周期的走势，近60天（一个季度，6倍于研判周期）的走势判断足够。
60天按每5天一根K线（5日势重于1日势），可以形成12根5日K线。
结合趋势和信号选股（趋势只代表一种可能性，而信号则代表确实发生了一些增大趋势概率的事件）。
用近一个季度的12根5日K线来预测未来的2根5日K线，
趋势判断参考亚当理论，未来2个5日K线的收盘价、最低价、平均价都必须符合上升趋势，
且预期的各类价格必须高于当前的5日K线（即最后一根5日K线）。
同时，最近的20天内（一个月）必须出现过持续不少于10天（两周）的平台期；
在满足趋势筛选的前提下，依据各类认同的日K线形态捕捉信号。
如果得到的选股结果超过2个，则需要结合主观判断进行筛选，
判断的立足点是未来一两周的走势（所以不考虑基本面），重点考虑消息面、支撑、阻力、板块走势等。
'''
